...
def generate_covid_clinic_billing(billing_ordinal: int):
    def at(filename):
        return join(r'P:\billing_reports', f'billing_{billing_ordinal}', filename)
    ...
    if billing_report_paths:
        ...
        for billing_report_path in billing_report_paths:
            ...
            billing_reports_cc.append(pd.read_csv(billing_report_path, encoding='ANSI', dtype=str))
        ...
        if client_bill_paths:
            ...
            for client_bill_path in client_bill_paths:
                cb = pd.read_csv(client_bill_path, encoding='ANSI')
        ...
        billing_report_cc['ICD 10 Code'] = 'Z20.822'
